...
pg_dump --file=keycloak-dev-25-2.sql --format=p --dbname=keycloak --username=root --host=renyoo-dev-rds.cluster-cbshcbhm3sxz.ap-southeast-1.rds.amazonaws.com --port=5432
pg_dump --file=keycloak-dev-25-2.sql --format=p --dbname=keycloak -t user_entity -t user_role_mapping -t credential --username=root --host=renyoo-dev-rds.cluster-cbshcbhm3sxz.ap-southeast-1.rds.amazonaws.com --port=5432
```
