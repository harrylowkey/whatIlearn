...
{{- define "queue.name" -}}
{{- printf "%s-queue" (default .Chart.Name .Values.nameOverride | trunc 63 | trimSuffix "-") -}}
{{- end }}
...
*/}}
{{- define "queue.chart" -}}
{{- $chartLabel := printf "%s-%s-queue" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end }}
